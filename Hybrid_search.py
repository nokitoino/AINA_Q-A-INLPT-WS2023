...
class HybridSearch:
    def __init__(self, data_path, faiss_index_path):
        ...
        os.environ['OPENAI_API_KEY'] = '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'
...
if __name__ == "__main__":
    hs = HybridSearch('/Users/anureddy/Desktop/SEM03/Natural_Language_Processing_with_Transformers/Project_QA/QA_PROJ/data/papers_latest.json', 
                      '/Users/anureddy/Desktop/SEM03/Natural_Language_Processing_with_Transformers/Project_QA/_Q-A-INLPT-WS2023/DB/faiss_index')
    data = hs.load_data()
